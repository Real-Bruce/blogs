...
比如买房，社会告诉你这是刚需安家最踏实的选择。但翻译成资产配置，这就是**高杠杆ALL IN单一城市的资产，锁仓二三十年，流动性接近为零**。你必须同时赌对人口、产业、政策甚至这个城市的命运，只要一个变量出错，你就无法退出。而社会叙事却把这包装成了稳定。
...
> **退休不是由年龄决定的，更不是国家规定的60岁或65岁才能领取的通关文牒。** 退休是一种独立的财务状态，完全可以不依赖任何组织。
